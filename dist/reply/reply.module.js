...
ReplyModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([writing_1.Writing, user_entitiy_1.User, reply_entity_1.Reply, alarm_entitiy_1.Alarm, nestedReply_entitiy_1.NestedReply]),
        ...
        providers: [reply_service_1.ReplyService, alarm_service_1.AlarmService],
    })
], ReplyModule);
