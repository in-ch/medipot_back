...
export class KakaoController {
  ...
  @ApiBody({})
  @ApiResponse({ description: '성공', type: OutputDto<MeOkOutputDto | MeErrorOutputDto> })
  @Post('/me')
  ...
  @ApiResponse({ description: '성공', type: OutputDto<RefreshOkOutputDto> })
  @Post('/refresh')
  ...
  @ApiResponse({ description: '성공', type: OutputDto<LogoutOutputDto> })
  @Post('/logout')
  ...
  @ApiResponse({ description: '성공', type: OutputDto<KakaoLoginOutputDto> })
  @Post('/login')
